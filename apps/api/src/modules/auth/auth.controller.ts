...
import { requireAuthUser } from '../../common/auth-context';
...
export class AuthController {
  ...
  async me(@Req() req: Request) {
    const userId = requireAuthUser(req).userId;
