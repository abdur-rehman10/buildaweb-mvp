...
Wire a frontend “Generate with AI” flow to the existing backend endpoint so users can generate site content from a prompt and continue directly into page editing.
